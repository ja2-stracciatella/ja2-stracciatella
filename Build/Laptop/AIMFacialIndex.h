...
#define		AIM_FI_LEFT_CLICK_TEXT_X					(STD_SCREEN_X + 116)
#define		AIM_FI_LEFT_CLICK_TEXT_Y					(STD_SCREEN_Y + 35 + LAPTOP_SCREEN_WEB_DELTA_Y)

#define		AIM_FI_CLICK_DESC_TEXT_Y_OFFSET		16

#define		AIM_FI_RIGHT_CLICK_TEXT_X					(STD_SCREEN_X + 500)
