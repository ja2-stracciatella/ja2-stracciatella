...
static void InitEditorItemStatsButtons(void)
{
	...
	iEditorButton[ITEMSTATS_DELETE_BTN] = CreateTextButton(L"Delete", FONT10ARIAL, FONT_RED, FONT_BLACK, 600, 441, 36, 16, MSYS_PRIORITY_NORMAL + 1, ItemStatsDeleteCallback);
}
...
{
	iEditorButton[idx] = CreateTextButton(text, FONT10ARIAL, FONT_YELLOW, FONT_BLACK, x, y, w, h, MSYS_PRIORITY_NORMAL, click);
}
...
static void InitEditorMercsToolbar(void)
{
	...
	//Orders
	iEditorButton[MERCS_ORDERS_STATIONARY]  = CreateTextButton(L"STATIONARY",    SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 200, 368, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_ONGUARD]     = CreateTextButton(L"ON GUARD",      SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 200, 380, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_ONCALL]      = CreateTextButton(L"ON CALL",       SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 200, 392, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_SEEKENEMY]   = CreateTextButton(L"SEEK ENEMY",    SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 200, 404, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_CLOSEPATROL] = CreateTextButton(L"CLOSE PATROL",  SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 270, 368, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_FARPATROL]   = CreateTextButton(L"FAR PATROL",    SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 270, 380, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_POINTPATROL] = CreateTextButton(L"POINT PATROL",  SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 270, 392, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	iEditorButton[MERCS_ORDERS_RNDPTPATROL] = CreateTextButton(L"RND PT PATROL", SMALLCOMPFONT, FONT_GRAY2, FONT_BLACK, 270, 404, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetOrdersCallback);
	for (INT32 x = 0; x < 8; x++)
	{
	...
	//Attitudes
	iEditorButton[MERCS_ATTITUDE_DEFENSIVE]   = CreateTextButton(L"DEFENSIVE",    SMALLCOMPFONT, FONT_GRAY4, FONT_BLACK, 200, 424, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetAttitudeCallback);
	iEditorButton[MERCS_ATTITUDE_BRAVESOLO]   = CreateTextButton(L"BRAVE SOLO",   SMALLCOMPFONT, FONT_GRAY4, FONT_BLACK, 200, 436, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetAttitudeCallback);
	iEditorButton[MERCS_ATTITUDE_BRAVEAID]    = CreateTextButton(L"BRAVE AID",    SMALLCOMPFONT, FONT_GRAY4, FONT_BLACK, 200, 448, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetAttitudeCallback);
	iEditorButton[MERCS_ATTITUDE_AGGRESSIVE]  = CreateTextButton(L"AGGRESSIVE",   SMALLCOMPFONT, FONT_GRAY4, FONT_BLACK, 270, 424, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetAttitudeCallback);
	iEditorButton[MERCS_ATTITUDE_CUNNINGSOLO] = CreateTextButton(L"CUNNING SOLO", SMALLCOMPFONT, FONT_GRAY4, FONT_BLACK, 270, 436, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetAttitudeCallback);
	iEditorButton[MERCS_ATTITUDE_CUNNINGAID]  = CreateTextButton(L"CUNNING AID",  SMALLCOMPFONT, FONT_GRAY4, FONT_BLACK, 270, 448, 70, 12, MSYS_PRIORITY_NORMAL, MercsSetAttitudeCallback);
	for (INT32 x = 0; x < 6; x++)
	{
	...
	MakeButtonRank(MERCS_ARMY_CODE,  410, SOLDIER_CLASS_ARMY);
	MakeButtonRank(MERCS_ADMIN_CODE, 424, SOLDIER_CLASS_ADMINISTRATOR);
	MakeButtonRank(MERCS_ELITE_CODE, 438, SOLDIER_CLASS_ELITE);
...
{
	iEditorButton[BUILDING_TOGGLE_ROOF_VIEW] = CreateTextButton(L"ROOFS",     SMALLCOMPFONT, FONT_YELLOW, FONT_BLACK, 110, 400, 50, 15, MSYS_PRIORITY_NORMAL, BuildingToggleRoofViewCallback);
	iEditorButton[BUILDING_TOGGLE_WALL_VIEW] = CreateTextButton(L"WALLS",     SMALLCOMPFONT, FONT_YELLOW, FONT_BLACK, 110, 415, 50, 15, MSYS_PRIORITY_NORMAL, BuildingToggleWallViewCallback);
...
static void InitEditorItemsToolbar(void)
{
	...
	iEditorButton[ITEMS_WEAPONS]    = CreateTextButton(L"Weapons",    BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 100, 440, 59, 20, MSYS_PRIORITY_NORMAL, ItemsWeaponsCallback);
	iEditorButton[ITEMS_AMMO]       = CreateTextButton(L"Ammo",       BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 159, 440, 40, 20, MSYS_PRIORITY_NORMAL, ItemsAmmoCallback);
	iEditorButton[ITEMS_ARMOUR]     = CreateTextButton(L"Armour",     BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 199, 440, 52, 20, MSYS_PRIORITY_NORMAL, ItemsArmourCallback);
	iEditorButton[ITEMS_EXPLOSIVES] = CreateTextButton(L"Explosives", BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 251, 440, 69, 20, MSYS_PRIORITY_NORMAL, ItemsExplosivesCallback);
	iEditorButton[ITEMS_EQUIPMENT1] = CreateTextButton(L"E1",         BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 320, 440, 21, 20, MSYS_PRIORITY_NORMAL, ItemsEquipment1Callback);
	iEditorButton[ITEMS_EQUIPMENT2] = CreateTextButton(L"E2",         BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 341, 440, 21, 20, MSYS_PRIORITY_NORMAL, ItemsEquipment2Callback);
	iEditorButton[ITEMS_EQUIPMENT3] = CreateTextButton(L"E3",         BLOCKFONT, FONT_MCOLOR_DKWHITE, FONT_BLACK, 362, 440, 21, 20, MSYS_PRIORITY_NORMAL, ItemsEquipment3Callback);
