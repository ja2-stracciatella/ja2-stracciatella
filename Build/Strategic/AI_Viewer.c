...
static BOOLEAN CreateAIViewer(void)
{
	...
	iViewerButton[VIEWER_EXIT] = CreateTextButton(L"Exit", BLOCKFONT2, FONT_RED, FONT_BLACK, BUTTON_USE_DEFAULT, 585, 425, 50, 30, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, ViewerExitCallback);
	...
	iViewerButton[COMPRESSION0]  = CreateTextButton(L"0",  FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT +  3, 20, 17, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, Compression0Callback);
	iViewerButton[COMPRESSION5]  = CreateTextButton(L"5",  FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 20, 20, 17, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, Compression5Callback);
	iViewerButton[COMPRESSION15] = CreateTextButton(L"15", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 37, 20, 18, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, Compression15Callback);
	iViewerButton[COMPRESSION60] = CreateTextButton(L"60", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 55, 20, 18, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, Compression60Callback);
/*
	iViewerButton[COMPRESSION6H] = CreateTextButton(L"6H", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 73, 20, 18, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, Compression6HCallback);
*/
	...
	iViewerButton[RESET_EASY]   = CreateTextButton(L"Easy",   FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, 526, 20, 35, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, EasyCallback);
	iViewerButton[RESET_NORMAL] = CreateTextButton(L"Normal", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, 561, 20, 44, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, NormalCallback);
	iViewerButton[RESET_HARD]   = CreateTextButton(L"Hard",   FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, 605, 20, 35, 16, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, HardCallback);

	iViewerButton[TEST_INCOMING_4SIDES] = CreateTextButton(L"Incoming 4 Sides",     FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 20, 100, 120, 18, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, TestIncoming4SidesCallback);
	iViewerButton[START_CREATURE_QUEST] = CreateTextButton(L"Start Creature Quest", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 20, 125, 120, 18, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, StartCreatureQuestCallback);
	iViewerButton[SPREAD_CREATURES]     = CreateTextButton(L"Spread Creatures",     FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 20, 150, 120, 18, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, SpreadCreaturesCallback);
	iViewerButton[CREATURE_ATTACK]      = CreateTextButton(L"Creature Attack",      FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 20, 175, 120, 18, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, CreatureAttackCallback);
	...
	iViewerButton[RELOAD_SECTOR] = CreateTextButton(L"Override Sector", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, 10, VIEWER_BOTTOM + 5, 90, 18, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, ReloadSectorCallback);

	iViewerButton[VIEW_ENEMIES]   = CreateTextButton(L"View Enemies",   FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT +  13, 40, 90, 20, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, ViewEnemiesCallback);
	iViewerButton[VIEW_CREATURES] = CreateTextButton(L"View Creatures", FONT12POINT1, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 103, 40, 90, 20, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, ViewCreaturesCallback);

	iViewerButton[BASEMENT1_BTN] = CreateTextButton(L"B1", FONT16ARIAL, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT +  58, 60, 30, 24, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, B1Callback);
	iViewerButton[BASEMENT2_BTN] = CreateTextButton(L"B2", FONT16ARIAL, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT +  88, 60, 30, 24, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, B2Callback);
	iViewerButton[BASEMENT3_BTN] = CreateTextButton(L"B3", FONT16ARIAL, FONT_BLACK, FONT_BLACK, BUTTON_USE_DEFAULT, VIEWER_RIGHT + 118, 60, 30, 24, MSYS_PRIORITY_HIGH, DEFAULT_MOVE_CALLBACK, B3Callback);
	if( gfViewEnemies )
