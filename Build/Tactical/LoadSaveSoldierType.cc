...
void ExtractSoldierType(const BYTE* const data, SOLDIERTYPE* const s)
{
	...
	EXTR_I8(d, s->bOldOverTerrainType)
...
void InjectSoldierType(BYTE* const data, const SOLDIERTYPE* const s)
{
	...
	INJ_I8(d, s->bOldOverTerrainType)
