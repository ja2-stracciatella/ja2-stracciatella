...
void createAllHardcodedItemModels(std::vector<const ItemModel*> &items)
{
  ...
  items[131] = new ItemModel(131, IC_GRENADE,       0,      TOSSCURS,     1,    38,   6,  4,     100, 6,    /* stun grenade       */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE );
  items[132] = new ItemModel(132, IC_GRENADE,       1,      TOSSCURS,     1,    48,   6,  4,     120, 5,    /* tear gas grenade   */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[133] = new ItemModel(133, IC_GRENADE,       2,      TOSSCURS,     1,    41,   6,  4,     500, 8,    /* mustard gas grenade*/  0,    -3,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[134] = new ItemModel(134, IC_GRENADE,       3,      TOSSCURS,     1,    50,   3,  6,     150, 6,    /* mini hand grenade  */  0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[135] = new ItemModel(135, IC_GRENADE,       4,      TOSSCURS,     1,    49,   6,  4,     200, 7,    /* reg hand grenade   */  0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[136] = new ItemModel(136, IC_BOMB,          5,      INVALIDCURS,  2,     3,  11,  2,     400, 7,    /* RDX                */  0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE);
  items[137] = new ItemModel(137, IC_BOMB,          6,      INVALIDCURS,  2,     0,  11,  1,     500, 6,    /* TNT (="explosives")*/  0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE);
  items[138] = new ItemModel(138, IC_BOMB,          7,      INVALIDCURS,  2,    23,  11,  1,    1000, 8,    /* HMX (=RDX+TNT)     */  0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE);
  items[139] = new ItemModel(139, IC_BOMB,          8,      INVALIDCURS,  1,    45,  11,  1,     750, 7,    /* C1  (=RDX+min oil) */  0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE);
  items[140] = new ItemModel(140, IC_BOMB,          9,      INVALIDCURS,  1,    40,  41,  2,     400, 9,    /* mortar shell       */  0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);

  items[141] = new ItemModel(141, IC_BOMB,          10,     BOMBCURS,     1,    46,   8,  1,     300, 5,    /* mine               */  0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE );
  items[142] = new ItemModel(142, IC_BOMB,          11,     INVALIDCURS,  1,    44,  11,  1,    1500, 9,    /* C4  ("plastique")  */  0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE);
  items[143] = new ItemModel(143, IC_BOMB,          12,     BOMBCURS,     1,    42,   4,  2,       0, 0,    /* trip flare         */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_NOT_BUYABLE | ITEM_REPAIRABLE );
  items[144] = new ItemModel(144, IC_BOMB,          13,     BOMBCURS,     1,    43,   4,  2,       0, 0,    /* trip klaxon        */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_NOT_BUYABLE | ITEM_REPAIRABLE );
  items[145] = new ItemModel(145, IC_BOMB,          14,     INVALIDCURS,  1,    107,  2,  4,     250, 6,    /* shaped charge      */  0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[146] = new ItemModel(146, IC_GRENADE,       15,     TOSSCURS,     2,    24,   1,  6,      50, 3,    /* break light (flare)*/  0,    0,      ITEM_DAMAGEABLE | ITEM_REPAIRABLE);
  items[147] = new ItemModel(147, IC_GRENADE,       16,     INVALIDCURS,  1,    97,  10,  4,     400, 8,    /* 40mm HE grenade    */  0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[148] = new ItemModel(148, IC_GRENADE,       17,     INVALIDCURS,  1,    111, 10,  4,     250, 6,    /* 40mm tear gas grnd */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[149] = new ItemModel(149, IC_GRENADE,       18,     INVALIDCURS,  1,    113, 10,  4,     200, 5,    /* 40mm stun grenade  */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[150] = new ItemModel(150, IC_GRENADE,       19,     INVALIDCURS,  1,    112, 10,  4,     100, 7,    /* 40mm smoke grenade */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);

  items[151] = new ItemModel(151, IC_GRENADE,       20,     TOSSCURS,     1,    98,   6,  4,      50, 4,    /* smoke hand grenade */  0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE);
  items[152] = new ItemModel(152, IC_BOMB,          21,     INVALIDCURS,  1,    40,  41,  8,     450, 0,    /* tank shell       */    0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR );
  items[153] = new ItemModel(153, IC_BOMB,          22,     INVALIDCURS,  1,    40,  41,  2,     450, 0,    /* fake struct ignite*/   0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_NOT_BUYABLE );
  items[154] = new ItemModel(154, IC_GRENADE,       23,     TOSSCURS,     2,    37,   6,  4,      50, 0,    /* creature cocktail*/    0,    0,      ITEM_DAMAGEABLE | ITEM_METAL );
  items[155] = new ItemModel(155, IC_BOMB,          24,     INVALIDCURS,  1,    40,  41,  2,     450, 0,    /* fake struct xplod*/    0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_NOT_BUYABLE );
  items[156] = new ItemModel(156, IC_BOMB,          25,     INVALIDCURS,  1,    40,  41,  2,     450, 0,    /* fake vehicle xplod*/   0,    -4,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_NOT_BUYABLE );
  items[157] = new ItemModel(157, IC_GRENADE,       26,     TOSSCURS,     1,    48,   6,  4,       0, 0,    /* BIG tear gas grenade*/ 0,    -2,     ITEM_DAMAGEABLE | ITEM_METAL | ITEM_REPAIRABLE | ITEM_NOT_BUYABLE );
  items[158] = new ItemModel(158, IC_GRENADE,       27,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* small creature gas */  0,    0,      0);
  items[159] = new ItemModel(159, IC_GRENADE,       28,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* big creature gas */    0,    0,      0);
  items[160] = new ItemModel(160, IC_GRENADE,       29,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* very sm creat gas */   0,    0,      0);

  //---ARMOUR---
  items[161] = new ItemModel(161, IC_ARMOUR,       0,     INVALIDCURS,  1,    66,   20, 0,     300, 2,    /* Flak jacket     */ 0,    +2,     IF_STANDARD_ARMOUR);
  items[162] = new ItemModel(162, IC_ARMOUR,       1,     INVALIDCURS,  2,    18,   22, 0,     350, 0,    /* Flak jacket w X */ 0,    +1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[163] = new ItemModel(163, IC_ARMOUR,       2,     INVALIDCURS,  2,    11,   18, 0,     400, 0,    /* Flak jacket w Y */ 0,    +3,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[164] = new ItemModel(164, IC_ARMOUR,       3,     INVALIDCURS,  1,    64,   32, 0,     500, 4,    /* Kevlar jacket   */ 0,    0,      IF_STANDARD_ARMOUR);
  items[165] = new ItemModel(165, IC_ARMOUR,       4,     INVALIDCURS,  2,    16,   35, 0,     600, 0,    /* Kevlar jack w X */ 0,    -1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[166] = new ItemModel(166, IC_ARMOUR,       5,     INVALIDCURS,  2,     9,   29, 0,     700, 0,    /* Kevlar jack w Y */ 0,    +1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[167] = new ItemModel(167, IC_ARMOUR,       6,     INVALIDCURS,  1,    65,   32, 0,    1000, 8,    /* Spectra jacket  */ 0,    -2,     IF_STANDARD_ARMOUR);
  items[168] = new ItemModel(168, IC_ARMOUR,       7,     INVALIDCURS,  2,    17,   35, 0,    1100, 0,    /* Spectra jack w X*/ 0,    -3,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[169] = new ItemModel(169, IC_ARMOUR,       8,     INVALIDCURS,  2,    10,   29, 0,    1200, 0,    /* Spectra jack w Y*/ 0,    -1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[170] = new ItemModel(170, IC_ARMOUR,       9,     INVALIDCURS,  1,    67,   39, 0,     650, 5,    /* Kevlar leggings */ 0,    0,      IF_STANDARD_ARMOUR);

  items[171] = new ItemModel(171, IC_ARMOUR,      10,     INVALIDCURS,  2,    19,   43, 0,     800, 0,    /* Kevlar legs w X */ 0,    -1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[172] = new ItemModel(172, IC_ARMOUR,      11,     INVALIDCURS,  2,    12,   35, 0,     950, 0,    /* Kevlar legs w Y */ 0,    +1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[173] = new ItemModel(173, IC_ARMOUR,      12,     INVALIDCURS,  1,    68,   39, 0,     900, 8,    /* Spectra leggings*/ 0,    -2,     IF_STANDARD_ARMOUR);
  items[174] = new ItemModel(174, IC_ARMOUR,      13,     INVALIDCURS,  2,    20,   43, 0,    1100, 0,    /* Spectra legs w X*/ 0,    -3,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[175] = new ItemModel(175, IC_ARMOUR,      14,     INVALIDCURS,  2,    13,   35, 0,    1300, 0,    /* Spectra legs w Y*/ 0,    -1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[176] = new ItemModel(176, IC_ARMOUR,      15,     INVALIDCURS,  1,    61,   14, 0,      50, 2,    /* Steel helmet    */ 0,    +2,     IF_STANDARD_ARMOUR | ITEM_METAL);
  items[177] = new ItemModel(177, IC_ARMOUR,      16,     INVALIDCURS,  1,    63,   14, 0,     200, 4,    /* Kevlar helmet   */ 0,    0,      IF_STANDARD_ARMOUR);
  items[178] = new ItemModel(178, IC_ARMOUR,      17,     INVALIDCURS,  2,    15,   15, 0,     250, 0,    /* Kevlar helm w X */ 0,    -1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[179] = new ItemModel(179, IC_ARMOUR,      18,     INVALIDCURS,  2,     8,   13, 0,     300, 0,    /* Kevlar helm w Y */ 0,    +1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[180] = new ItemModel(180, IC_ARMOUR,      19,     INVALIDCURS,  1,    62,   14, 0,     450, 7,    /* Spectra helmet  */ 0,    -2,     IF_STANDARD_ARMOUR);

  items[181] = new ItemModel(181, IC_ARMOUR,      20,     INVALIDCURS,  2,    14,   15, 0,     550, 0,    /* Spectra helm w X*/ 0,    -3,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[182] = new ItemModel(182, IC_ARMOUR,      21,     INVALIDCURS,  2,     7,   13, 0,     650, 0,    /* Spectra helm w Y*/ 0,    -1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[183] = new ItemModel(183, IC_ARMOUR,      22,     INVALIDCURS,  1,    81,   12, 2,     250, 5,    /* Ceramic plates  */ 0,    -4,     (IF_STANDARD_ARMOUR | ITEM_ATTACHMENT) & (~ITEM_REPAIRABLE) );
  items[184] = new ItemModel(184, IC_ARMOUR,      23,     INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* Infant crt hide */ 0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR | ITEM_DEFAULT_UNDROPPABLE);
  items[185] = new ItemModel(185, IC_ARMOUR,      24,     INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* Yng male hide */   0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR | ITEM_DEFAULT_UNDROPPABLE);
  items[186] = new ItemModel(186, IC_ARMOUR,      25,     INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* Old male hide */   0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR | ITEM_DEFAULT_UNDROPPABLE);
  items[187] = new ItemModel(187, IC_ARMOUR,      26,     INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* Queen cret hide */ 0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR | ITEM_DEFAULT_UNDROPPABLE);
  items[188] = new ItemModel(188, IC_ARMOUR,      27,     INVALIDCURS,  1,    96,   20, 0,     200, 2,    /* Leather jacket  */ 0,    +4,     IF_STANDARD_ARMOUR );
  // NOTE: THE FOLLOWING ITEM'S PRICE VALUE IS IN DIALOGUE AND SHOULD NOT BE CHANGED
  items[189] = new ItemModel(189, IC_ARMOUR,      28,     INVALIDCURS,  1,    116,  20, 0,     950, 0,    /* L jacket w kev  */ 0,    +2,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[190] = new ItemModel(190, IC_ARMOUR,      29,     INVALIDCURS,  1,    117,  20, 0,    1200, 0,    /* L jacket w kev 18*/0,    +1,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );

  items[191] = new ItemModel(191, IC_ARMOUR,      30,     INVALIDCURS,  1,    118,  20, 0,    1500, 0,    /* L jacket w kev c*/ 0,    +3,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[192] = new ItemModel(192, IC_ARMOUR,      31,     INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* yng fem hide */    0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR | ITEM_DEFAULT_UNDROPPABLE);
  items[193] = new ItemModel(193, IC_ARMOUR,      32,     INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* old fem hide */    0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE | ITEM_NOT_EDITOR | ITEM_DEFAULT_UNDROPPABLE);
  items[194] = new ItemModel(194, IC_ARMOUR,      33,     INVALIDCURS,  2,    25,   3,  1,      10, 1,    /* t-shirt */         0,    0,      ITEM_DAMAGEABLE | ITEM_SHOW_STATUS | ITEM_UNAERODYNAMIC);
  items[195] = new ItemModel(195, IC_ARMOUR,      33,     INVALIDCURS,  2,    34,   3,  1,      10, 1,    /* t-shirt D. rules*/ 0,    0,      ITEM_DAMAGEABLE | ITEM_SHOW_STATUS | ITEM_UNAERODYNAMIC);
  items[196] = new ItemModel(196, IC_ARMOUR,      34,     INVALIDCURS,  1,    137,    32, 0,     700, 6,    /* Kevlar2 jacket  */ 0,    -1,     IF_STANDARD_ARMOUR);
  items[197] = new ItemModel(197, IC_ARMOUR,      35,     INVALIDCURS,  2,    40,   35, 0,     800, 0,    /* Kevlar2 jack w X*/ 0,    -2,     IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[198] = new ItemModel(198, IC_ARMOUR,      36,     INVALIDCURS,  2,    41,   29, 0,     900, 0,    /* Kevlar2 jack w Y*/ 0,    0,      IF_STANDARD_ARMOUR | ITEM_NOT_BUYABLE );
  items[199] = new ItemModel(199, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[200] = new ItemModel(200, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);

  //---MISC---
  items[201] = new ItemModel(201, IC_MEDKIT,      0,      AIDCURS,      1,    73,   5,  4,     100, 1,    /* First aid kit */   0,    0,      IF_STANDARD_KIT);
  items[202] = new ItemModel(202, IC_MEDKIT,      0,      AIDCURS,      1,    86,   18, 0,     300, 1,    /* Medical Kit   */   0,    0,      IF_STANDARD_KIT | ITEM_METAL);
  items[203] = new ItemModel(203, IC_KIT,         0,      REPAIRCURS,   2,    21,   50, 0,     250, 1,    /* Tool Kit      */   0,    0,      IF_STANDARD_KIT | ITEM_METAL);
  items[204] = new ItemModel(204, IC_KIT,         0,      INVALIDCURS,  1,    78,   3,  1,     250, 3,    /* Locksmith kit */   0,    -2,     IF_STANDARD_KIT | ITEM_METAL | ITEM_REPAIRABLE);
  items[205] = new ItemModel(205, IC_KIT,         0,      INVALIDCURS,  1,    58,   1,  4,     250, 5,    /* Camouflage kit*/   0,    0,      IF_STANDARD_KIT);
  items[206] = new ItemModel(206, IC_MISC,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[207] = new ItemModel(207, IC_MISC,        0,      INVALIDCURS,  1,    52,   5,  4,     300, 5,    /* Silencer      */   0,    0,      ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ATTACHMENT);
  items[208] = new ItemModel(208, IC_MISC,        0,      INVALIDCURS,  1,    76,   9,  4,     500, 6,    /* Sniper scope  */   0,    0,      ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ATTACHMENT);
  items[209] = new ItemModel(209, IC_MISC,        0,      INVALIDCURS,  1,    69,   5,  2,      50, 4,    /* Bipod         */   0,    +5,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ATTACHMENT);
  items[210] = new ItemModel(210, IC_FACE,        0,      INVALIDCURS,  1,    77,   9,  1,     400, 7,    /* Extended ear  */   0,    -3,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC );

  items[211] = new ItemModel(211, IC_FACE,        0,      INVALIDCURS,  1,    74,   9,  1,     800, 7,    /* Night goggles */   0,    -1,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC );
  items[212] = new ItemModel(212, IC_FACE,        0,      INVALIDCURS,  1,    55,   2,  4,     150, 3,    /* Sun goggles   */   0,    +3,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE );
  items[213] = new ItemModel(213, IC_FACE,        0,      INVALIDCURS,  1,    75,   9,  1,     100, 4,    /* Gas mask      */   0,    +1,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE );
  items[214] = new ItemModel(214, IC_KIT,         0,      INVALIDCURS,  2,     5,  10,  4,      10, 1,    /* Canteen       */   0,    0,      ITEM_DAMAGEABLE);
  items[215] = new ItemModel(215, IC_MISC,        0,      INVALIDCURS,  1,    80,  10,  1,     200, 4,    /* Metal detector*/   0,    -2,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC );
  items[216] = new ItemModel(216, IC_MISC,        0,      INVALIDCURS,  2,     6,   1,  4,     900, 7,    /* Compound 18   */   0,    0,      ITEM_DAMAGEABLE);
  items[217] = new ItemModel(217, IC_MISC,        0,      INVALIDCURS,  2,    42,   1,  4,    2500, 0,    /* Jar/QueenBlood*/   0,    0,      ITEM_DAMAGEABLE | ITEM_NOT_BUYABLE);
  items[218] = new ItemModel(218, IC_MISC,        0,      INVALIDCURS,  2,     2,   1,  4,     500, 1,    /* Jar/Elixir    */   0,    0,      ITEM_DAMAGEABLE );
  items[219] = new ItemModel(219, IC_MONEY,       0,      INVALIDCURS,  2,     1,   1,  1,       0, 0,    /* Money         */   0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[220] = new ItemModel(220, IC_MISC,        0,      JARCURS,      1,    71,   1,  2,      10, 1,    /* Glass jar     */   0,    0,      ITEM_DAMAGEABLE);

  items[221] = new ItemModel(221, IC_MISC,        0,      INVALIDCURS,  1,    72,   5,  2,      50, 1,    /* Jar/CreatureBlood*/0,    0,      ITEM_DAMAGEABLE | ITEM_NOT_BUYABLE);
  items[222] = new ItemModel(222, IC_MISC,        0,      INVALIDCURS,  1,    70,   1,  8,     150, 4,    /* Adren Booster */   0,    0,      ITEM_DAMAGEABLE | ITEM_UNAERODYNAMIC);
  items[223] = new ItemModel(223, IC_MISC,        0,      INVALIDCURS,  1,    47,   1,  4,     100, 3,    /* Detonator     */   0,    +1,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_ATTACHMENT | ITEM_METAL);
  items[224] = new ItemModel(224, IC_MISC,        0,      INVALIDCURS,  1,    47,   1,  4,     200, 6,    /* Rem Detonator */   0,    -1,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_ATTACHMENT | ITEM_METAL | ITEM_ELECTRONIC );
  items[225] = new ItemModel(225, IC_MISC,        0,      INVALIDCURS,  1,    93,   1,  8,       0, 0,    /* Videotape     */   0,    0,      ITEM_NOT_BUYABLE);
  items[226] = new ItemModel(226, IC_MISC,        0,      INVALIDCURS,  1,    94,   1,  8,       0, 0,    /* Deed          */   0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[227] = new ItemModel(227, IC_MISC,        0,      INVALIDCURS,  1,    56,   1,  1,       0, 0,    /* Letter        */   0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[228] = new ItemModel(228, IC_MISC,        0,      INVALIDCURS,  1,    59,   1,  1,       0, 0,    /* Diskette      */   0,    0,      ITEM_NOT_BUYABLE);
  items[229] = new ItemModel(229, IC_MISC,        0,      INVALIDCURS,  1,  124,    0,  1,    3000, 0,    /* Chalice       */   0,    0,      ITEM_NOT_BUYABLE);
  items[230] = new ItemModel(230, IC_MISC,        0,      INVALIDCURS,  1,  120,    1,  4,      50, 0,    /* Bloodcat claws*/   0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);

  items[231] = new ItemModel(231, IC_MISC,        0,      INVALIDCURS,  1,  121,    1,  4,     100, 0,    /* Bloodcat teeth*/   0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);
  items[232] = new ItemModel(232, IC_MISC,        0,      INVALIDCURS,  3,    9,   60,  0,     400, 0,    /* Bloodcat pelt */   0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);
  items[233] = new ItemModel(233, IC_MISC,        0,      INVALIDCURS,  1,    54,   0,  99,      0, 0,    /* Switch        */   0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[234] = new ItemModel(234, IC_MISC,        0,      INVALIDCURS,  1,    47,   0,  99,      0, 0,    /* Action item   */   0,    0,      ITEM_NOT_BUYABLE );
  items[235] = new ItemModel(235, IC_MISC,        0,      INVALIDCURS,  1,    70,   1,  6,     300, 6,    /* Regen Booster */   0,    0,      ITEM_DAMAGEABLE | ITEM_UNAERODYNAMIC);
  items[236] = new ItemModel(236, IC_MISC,        0,      INVALIDCURS,  1,    70,   0,  99,      0, 0,    /* syringe 3     */   0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[237] = new ItemModel(237, IC_MISC,        0,      INVALIDCURS,  1,    70,   0,  99,      0, 0,    /* syringe 4     */   0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[238] = new ItemModel(238, IC_MISC,        0,      INVALIDCURS,  1,    70,   0,  99,      0, 0,    /* syringe 5     */   0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[239] = new ItemModel(239, IC_MISC,        0,      INVALIDCURS,  1,    72,   5,  2,      10, 1,    /* Jar/Human Blood*/  0,    0,      ITEM_DAMAGEABLE);
  items[240] = new ItemModel(240, IC_MISC,        0,      INVALIDCURS,  1,    0,    0,  0,       0, 0,    /* ownership     */   0,    0,      ITEM_NOT_BUYABLE);

  items[241] = new ItemModel(241, IC_MISC,        0,      INVALIDCURS,  1,    51,   4,  4,     750, 8,    /* Laser scope   */   0,    -1,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ATTACHMENT | ITEM_ELECTRONIC );
  items[242] = new ItemModel(242, IC_MISC,        0,      REMOTECURS,   1,    54,   9,  4,     400, 6,    /* Remote bomb trig*/ 0,    -2,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC );
  items[243] = new ItemModel(243, IC_MISC,        0,      WIRECUTCURS,  1,    88,   4,  2,      20, 2,    /* Wirecutters   */   0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL);
  items[244] = new ItemModel(244, IC_MISC,        0,      INVALIDCURS,  1,    90,   9,  4,      30, 2,    /* Duckbill      */   0,    +5,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ATTACHMENT);
  items[245] = new ItemModel(245, IC_MISC,        0,      INVALIDCURS,  1,    106,  20, 1,      30, 1,    /* Alcohol  */        0,    0,      ITEM_DAMAGEABLE);
  items[246] = new ItemModel(246, IC_FACE,        0,      INVALIDCURS,  1,    74,   11, 1,    1500, 10,   /* UV goggles */      0,    -1,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC );
  items[247] = new ItemModel(247, IC_MISC,        0,      INVALIDCURS,  0,    44,   21, 0,      30, 0,    /* discarded LAW*/    0,    0,      IF_TWOHANDED_GUN | ITEM_NOT_BUYABLE );
  items[248] = new ItemModel(248, IC_MISC,        0,      INVALIDCURS,  3,    0,    40, 0,       0, 0,    /* head - generic */  0,    0,      ITEM_DAMAGEABLE);
  items[249] = new ItemModel(249, IC_MISC,        0,      INVALIDCURS,  3,    1,    40, 0,       0, 0,    /* head - Imposter*/  0,    0,      ITEM_DAMAGEABLE);
  items[250] = new ItemModel(250, IC_MISC,        0,      INVALIDCURS,  3,    2,    40, 0,       0, 0,    /* head - T-Rex */    0,    0,      ITEM_DAMAGEABLE);

  items[251] = new ItemModel(251, IC_MISC,        0,      INVALIDCURS,  3,    3,    40, 0,       0, 0,    /* head - Slay */     0,    0,      ITEM_DAMAGEABLE);
  items[252] = new ItemModel(252, IC_MISC,        0,      INVALIDCURS,  3,    4,    40, 0,       0, 0,    /* head - Druggist */ 0,    0,      ITEM_DAMAGEABLE);
  items[253] = new ItemModel(253, IC_MISC,        0,      INVALIDCURS,  3,    5,    40, 0,       0, 0,    /* head - Matron */   0,    0,      ITEM_DAMAGEABLE);
  items[254] = new ItemModel(254, IC_MISC,        0,      INVALIDCURS,  3,    6,    40, 0,       0, 0,    /* head - Tiffany */  0,    0,      ITEM_DAMAGEABLE);
  items[255] = new ItemModel(255, IC_MISC,        0,      INVALIDCURS,  1,    100,  12, 1,      20, 1,    /* wine     */        0,    0,      ITEM_DAMAGEABLE);
  items[256] = new ItemModel(256, IC_MISC,        0,      INVALIDCURS,  1,    101,  4,  4,      10, 1,    /* beer     */        0,    0,      ITEM_DAMAGEABLE);
  items[257] = new ItemModel(257, IC_MISC,        0,      INVALIDCURS,  1,    99,   0,  2,      20, 3,    /* pornos   */        0,    0,      ITEM_DAMAGEABLE);
  items[258] = new ItemModel(258, IC_MISC,        0,      INVALIDCURS,  0,    43,   20, 0,     900, 6,    /* video camera */    0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC  );
  items[259] = new ItemModel(259, IC_FACE,        0,      INVALIDCURS,  0,    42,   5,  1,    2500, 0,    /* robot remote */    0,    -5,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC  );
  items[260] = new ItemModel(260, IC_MISC,        0,      INVALIDCURS,  1,    103, 20,  0,     500, 0,    /* creature claws */  0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);

  items[261] = new ItemModel(261, IC_MISC,        0,      INVALIDCURS,  3,    7,   40,  0,     250, 0,    /* creature flesh */  0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);
  items[262] = new ItemModel(262, IC_MISC,        0,      INVALIDCURS,  1,    104, 10,  0,    1000, 0,    /* creature organ */  0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);
  items[263] = new ItemModel(263, IC_MISC,        0,      REMOTECURS,   1,    54,   9,  4,     400, 6,    /* Remote trigger*/   0,    -2,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL);
  items[264] = new ItemModel(264, IC_MISC,        0,      INVALIDCURS,  0,    47,   2,  8,     500, 2,    /* gold watch */      0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL);
  items[265] = new ItemModel(265, IC_MISC,        0,      INVALIDCURS,  1,    136, 100, 0,     200, 2,    /* golf clubs */      0,    0,      ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL);
  items[266] = new ItemModel(266, IC_FACE,        0,      INVALIDCURS,  3,    11,   5,  1,     100, 1,    /* walkman */         0,    -4,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC );
  items[267] = new ItemModel(267, IC_MISC,        0,      INVALIDCURS,  3,    8,   50,  0,     300, 2,    /* portable tv */     0,    -3,     ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_ELECTRONIC );
  items[268] = new ItemModel(268, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[269] = new ItemModel(269, IC_MISC,        0,      INVALIDCURS,  3,    10,  10,  1,      30, 1,    /* cigars */          0,    0,      ITEM_DAMAGEABLE );
  items[270] = new ItemModel(270, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);

  items[271] = new ItemModel(271, IC_KEY,         0,      INVALIDCURS,  1,    82,   1,  8,       0, 0,    /* dull gold key */   0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[272] = new ItemModel(272, IC_KEY,         1,      INVALIDCURS,  1,    83,   1,  8,       0, 0,    /* silver key */      0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[273] = new ItemModel(273, IC_KEY,         2,      INVALIDCURS,  1,    84,   1,  8,       0, 0,    /* diamond-shpd key */0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[274] = new ItemModel(274, IC_KEY,         3,      INVALIDCURS,  1,    87,   1,  8,       0, 0,    /* bright gold key */ 0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[275] = new ItemModel(275, IC_KEY,         4,      INVALIDCURS,  1,    91,   1,  8,       0, 0,    /* gold key */        0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[276] = new ItemModel(276, IC_KEY,         5,      INVALIDCURS,  1,    92,   1,  8,       0, 0,    /* small gold key */  0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[277] = new ItemModel(277, IC_KEY,         6,      INVALIDCURS,  1,    108,  1,  8,       0, 0,    /* electronic */      0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL | ITEM_ELECTRONIC );
  items[278] = new ItemModel(278, IC_KEY,         7,      INVALIDCURS,  1,    109,  1,  8,       0, 0,    /* passcard       */  0,    0,      ITEM_NOT_BUYABLE | ITEM_METAL);
  items[279] = new ItemModel(279, IC_KEY,         8,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[280] = new ItemModel(280, IC_KEY,         9,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);

  items[281] = new ItemModel(281, IC_KEY,         10,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[282] = new ItemModel(282, IC_KEY,         11,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[283] = new ItemModel(283, IC_KEY,         12,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[284] = new ItemModel(284, IC_KEY,         13,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[285] = new ItemModel(285, IC_KEY,         14,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[286] = new ItemModel(286, IC_KEY,         15,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[287] = new ItemModel(287, IC_KEY,         16,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[288] = new ItemModel(288, IC_KEY,         17,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[289] = new ItemModel(289, IC_KEY,         18,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[290] = new ItemModel(290, IC_KEY,         19,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);

  items[291] = new ItemModel(291, IC_KEY,         20,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[292] = new ItemModel(292, IC_KEY,         21,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[293] = new ItemModel(293, IC_KEY,         22,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[294] = new ItemModel(294, IC_KEY,         23,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[295] = new ItemModel(295, IC_KEY,         24,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[296] = new ItemModel(296, IC_KEY,         25,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[297] = new ItemModel(297, IC_KEY,         26,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[298] = new ItemModel(298, IC_KEY,         27,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[299] = new ItemModel(299, IC_KEY,         28,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[300] = new ItemModel(300, IC_KEY,         29,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);

  items[301] = new ItemModel(301, IC_KEY,         30,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[302] = new ItemModel(302, IC_KEY,         31,     INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* key      */        0,    0,      ITEM_NOT_EDITOR | ITEM_METAL);
  items[303] = new ItemModel(303, IC_MISC,        0,      INVALIDCURS,  2,    31,   4,  0,     150, 2,    /* silver platter */  0,    0,      ITEM_DAMAGEABLE | ITEM_METAL);
  items[304] = new ItemModel(304, IC_MISC,        0,      INVALIDCURS,  2,    30,   1,  6,       5, 1,    /* duct tape */       0,    0,      ITEM_DAMAGEABLE | ITEM_HIDDEN_ADDON );
  items[305] = new ItemModel(305, IC_MISC,        0,      INVALIDCURS,  2,    28,   3,  1,      20, 0,    /* aluminum rod */    0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE | ITEM_METAL | ITEM_HIDDEN_ADDON);
  items[306] = new ItemModel(306, IC_MISC,        0,      INVALIDCURS,  2,    32,   1,  8,       0, 0,    /* spring */          0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE | ITEM_METAL | ITEM_UNAERODYNAMIC | ITEM_HIDDEN_ADDON);
  items[307] = new ItemModel(307, IC_MISC,        0,      INVALIDCURS,  2,    33,   4,  1,      25, 0,    /* a. rod & spring */ 0,    0,      ITEM_NOT_BUYABLE | ITEM_REPAIRABLE | ITEM_DAMAGEABLE | ITEM_METAL | ITEM_INSEPARABLE);
  items[308] = new ItemModel(308, IC_MISC,        0,      INVALIDCURS,  1,   133,   4,  1,      20, 0,    /* steel rod */       0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE | ITEM_METAL | ITEM_HIDDEN_ADDON);
  items[309] = new ItemModel(309, IC_MISC,        0,      INVALIDCURS,  1,   132,   2,  6,       5, 3,    /* quick glue */      0,    0,      ITEM_DAMAGEABLE  | ITEM_HIDDEN_ADDON);
  items[310] = new ItemModel(310, IC_MISC,        0,      INVALIDCURS,  1,   134,   6,  1,     150, 0,    /* gun barrel xtndr */0,    0,      ITEM_NOT_BUYABLE | ITEM_REPAIRABLE | ITEM_DAMAGEABLE | ITEM_METAL | ITEM_INSEPARABLE);

  items[311] = new ItemModel(311, IC_MISC,        0,      INVALIDCURS,  2,    35,   1,  8,       0, 0,    /* string */          0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC  | ITEM_HIDDEN_ADDON);
  items[312] = new ItemModel(312, IC_MISC,        0,      INVALIDCURS,  2,    27,   1,  1,       0, 0,    /* tin can */         0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC  | ITEM_HIDDEN_ADDON);
  items[313] = new ItemModel(313, IC_MISC,        0,      TINCANCURS,   2,    36,   2,  4,       0, 0,    /* string & tin can */0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[314] = new ItemModel(314, IC_MISC,        0,      INVALIDCURS,  1,  122,    3,  6,       5, 0,    /* marbles */         0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE );
  items[315] = new ItemModel(315, IC_MISC,        0,      INVALIDCURS,  1,  127,    6,  1,     200, 6,    /* lame boy */        0,    0,      ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_ELECTRONIC | ITEM_HIDDEN_ADDON);
  items[316] = new ItemModel(316, IC_MISC,        0,      INVALIDCURS,  1,  128,    1,  8,       5, 1,    /* copper wire */     0,    0,      ITEM_METAL | ITEM_HIDDEN_ADDON );
  items[317] = new ItemModel(317, IC_MISC,        0,      INVALIDCURS,  1,  126,    7,  1,      50, 0,    /* display unit */    0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_ELECTRONIC | ITEM_HIDDEN_ADDON);
  items[318] = new ItemModel(318, IC_MISC,        0,      INVALIDCURS,  1,  130,    1,  1,     100, 5,    /* fumble pak */      0,    0,      ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_ELECTRONIC);
  items[319] = new ItemModel(319, IC_MISC,        0,      INVALIDCURS,  1,  131,    1,  2,      10, 5,    /* xray bulb */       0,    0,      ITEM_DAMAGEABLE | ITEM_HIDDEN_ADDON);
  items[320] = new ItemModel(320, IC_MISC,        0,      INVALIDCURS,  2,   29,    1,  8,       1, 1,    /* chewing gum */     0,    0,      ITEM_DAMAGEABLE | ITEM_HIDDEN_ADDON);

  items[321] = new ItemModel(321, IC_MISC,        0,      INVALIDCURS,  1,  129,    3,  1,     100, 0,    /* flash device */    0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC | ITEM_HIDDEN_ADDON);
  items[322] = new ItemModel(322, IC_MISC,        0,      INVALIDCURS,  2,   26,    1,  6,       5, 1,    /* batteries */       0,    0,      ITEM_DAMAGEABLE);
  items[323] = new ItemModel(323, IC_MISC,        0,      INVALIDCURS,  1,  123,    1,  8,       0, 0,    /* elastic */         0,    0,      ITEM_NOT_BUYABLE | ITEM_UNAERODYNAMIC);
  items[324] = new ItemModel(324, IC_MISC,        0,      REMOTECURS,   1,  125,   10,  1,    2500, 0,    /* xray device */     0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE | ITEM_REPAIRABLE | ITEM_METAL | ITEM_ELECTRONIC);
  items[325] = new ItemModel(325, IC_MONEY,       0,      INVALIDCURS,  2,   38,    2,  1,     100, 0,    /* silver   */        0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);
  items[326] = new ItemModel(326, IC_MONEY,       0,      INVALIDCURS,  1,  135,    2,  1,     300, 0,    /* gold     */        0,    0,      ITEM_NOT_BUYABLE | ITEM_DAMAGEABLE);
  items[327] = new ItemModel(327, IC_KIT,         0,      REFUELCURS,   2,   39,   20,  0,     250, 0,    /* gas can */         0,    0,      ITEM_DAMAGEABLE);
  items[328] = new ItemModel(328, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[329] = new ItemModel(329, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[330] = new ItemModel(330, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);

  items[331] = new ItemModel(331, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[332] = new ItemModel(332, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[333] = new ItemModel(333, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[334] = new ItemModel(334, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[335] = new ItemModel(335, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[336] = new ItemModel(336, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[337] = new ItemModel(337, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[338] = new ItemModel(338, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[339] = new ItemModel(339, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[340] = new ItemModel(340, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);

  items[341] = new ItemModel(341, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[342] = new ItemModel(342, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[343] = new ItemModel(343, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[344] = new ItemModel(344, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[345] = new ItemModel(345, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[346] = new ItemModel(346, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[347] = new ItemModel(347, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[348] = new ItemModel(348, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[349] = new ItemModel(349, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
  items[350] = new ItemModel(350, IC_NONE,        0,      INVALIDCURS,  0,    0,    0,  0,       0, 0,    /* nothing! */        0,    0,      0);
}
