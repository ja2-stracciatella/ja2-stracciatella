...
SOLDIERTYPE* TacticalCreateSoldier(const SOLDIERCREATE_STRUCT* pCreateStruct, UINT8* pubID);
...
BOOLEAN InternalTacticalRemoveSoldier(SOLDIERTYPE* s, BOOLEAN fRemoveVehicle);
