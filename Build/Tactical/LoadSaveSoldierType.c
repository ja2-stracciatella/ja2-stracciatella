...
void ExtractSoldierType(const BYTE* Src, SOLDIERTYPE* Soldier)
{
	...
	EXTR_FLOAT(S, Soldier->dOldXPos)
	EXTR_FLOAT(S, Soldier->dOldYPos)
	...
	EXTR_BOOL(S, Soldier->fUInewMerc)
	...
	EXTR_U8(S, Soldier->ubAttackerID)
	EXTR_U8(S, Soldier->ubPreviousAttackerID)
	...
	EXTR_BOOL(S, Soldier->fTurningToFall)
	...
	EXTR_U16A(S, Soldier->usFrontArcFullTileList, lengthof(Soldier->usFrontArcFullTileList))
	EXTR_I16A(S, Soldier->usFrontArcFullTileGridNos, lengthof(Soldier->usFrontArcFullTileGridNos))
	EXTR_SKIP(S, 2)
	EXTR_PTR(S, Soldier->p8BPPPalette)
	EXTR_PTR(S, Soldier->p16BPPPalette_UNUSED)
	EXTR_PTRA(S, Soldier->pShades)
	EXTR_PTRA(S, Soldier->pGlowShades)
	EXTR_PTR(S, Soldier->pCurrentShade_UNUSED)
	...
	EXTR_SKIP(S, 2)
	EXTR_PTR(S, Soldier->pBackGround)
	EXTR_PTR(S, Soldier->pZBackground)
	EXTR_U16(S, Soldier->usUnblitX)
	EXTR_U16(S, Soldier->usUnblitY)
	EXTR_U16(S, Soldier->usUnblitWidth)
	EXTR_U16(S, Soldier->usUnblitHeight)
	...
	EXTR_I16(S, Soldier->usLastRandomAnim)
	...
	EXTR_I8(S, Soldier->bUnderEscort)
	...
	EXTR_BOOL(S, Soldier->fForceRenderColor)
	EXTR_BOOL(S, Soldier->fForceNoRenderPaletteCycle)
	EXTR_I16(S, Soldier->sLocatorOffX)
	EXTR_I16(S, Soldier->sLocatorOffY)
	EXTR_BOOL(S, Soldier->fStopPendingNextTile)
	...
	EXTR_SKIP(S, 2)
	EXTR_U32(S, Soldier->uiStartMovementTime)
	EXTR_U32(S, Soldier->uiOptimumMovementTime)
	EXTR_U32(S, Soldier->usLastUpdateTime)
	EXTR_BOOL(S, Soldier->fIsSoldierMoving)
	EXTR_BOOL(S, Soldier->fIsSoldierDelayed)
	EXTR_BOOL(S, Soldier->fSoldierUpdatedFromNetwork)
	EXTR_SKIP(S, 1)
	EXTR_U32(S, Soldier->uiSoldierUpdateNumber)
	EXTR_BYTE(S, Soldier->ubSoldierUpdateType)
	EXTR_SKIP(S, 3)
	...
	EXTR_BOOL(S, Soldier->fReactingFromBeingShot)
	...
	EXTR_U8(S, Soldier->ubHoursOnAssignment)
	EXTR_U8(S, Soldier->ubMercJustFired)
	...
	EXTR_U8(S, Soldier->ubPendingActionInterrupted)
	...
	EXTR_U8(S, Soldier->ubCTGTTargetID)
	...
	EXTR_BOOL(S, Soldier->fDieSoundUsed)
	...
	EXTR_I8A(S, Soldier->bFillerBytes, lengthof(Soldier->bFillerBytes))
	...
	EXTR_I8(S, Soldier->bYetAnotherPaddingSpace)
	...
	EXTR_I16(S, Soldier->bFillerDude)
...
void InjectSoldierType(BYTE* Dst, const SOLDIERTYPE* Soldier)
{
	...
	INJ_FLOAT(D, Soldier->dOldXPos)
	INJ_FLOAT(D, Soldier->dOldYPos)
	...
	INJ_U8(D, Soldier->ubAttackerID)
	INJ_U8(D, Soldier->ubPreviousAttackerID)
	...
	INJ_BOOL(D, Soldier->fTurningToFall)
	...
	INJ_U16A(D, Soldier->usFrontArcFullTileList, lengthof(Soldier->usFrontArcFullTileList))
	INJ_I16A(D, Soldier->usFrontArcFullTileGridNos, lengthof(Soldier->usFrontArcFullTileGridNos))
	INJ_SKIP(D, 2)
	INJ_PTR(D, Soldier->p8BPPPalette)
	INJ_PTR(D, Soldier->p16BPPPalette_UNUSED)
	INJ_PTRA(D, Soldier->pShades)
	INJ_PTRA(D, Soldier->pGlowShades)
	INJ_PTR(D, Soldier->pCurrentShade_UNUSED)
	...
	INJ_SKIP(D, 2)
	INJ_PTR(D, Soldier->pBackGround)
	INJ_PTR(D, Soldier->pZBackground)
	INJ_U16(D, Soldier->usUnblitX)
	INJ_U16(D, Soldier->usUnblitY)
	INJ_U16(D, Soldier->usUnblitWidth)
	INJ_U16(D, Soldier->usUnblitHeight)
	...
	INJ_I16(D, Soldier->usLastRandomAnim)
	...
	INJ_BOOL(D, Soldier->fForceRenderColor)
	INJ_BOOL(D, Soldier->fForceNoRenderPaletteCycle)
	INJ_I16(D, Soldier->sLocatorOffX)
	INJ_I16(D, Soldier->sLocatorOffY)
	INJ_BOOL(D, Soldier->fStopPendingNextTile)
	...
	INJ_SKIP(D, 2)
	INJ_U32(D, Soldier->uiStartMovementTime)
	INJ_U32(D, Soldier->uiOptimumMovementTime)
	INJ_U32(D, Soldier->usLastUpdateTime)
	INJ_BOOL(D, Soldier->fIsSoldierMoving)
	INJ_BOOL(D, Soldier->fIsSoldierDelayed)
	INJ_BOOL(D, Soldier->fSoldierUpdatedFromNetwork)
	INJ_SKIP(D, 1)
	INJ_U32(D, Soldier->uiSoldierUpdateNumber)
	INJ_BYTE(D, Soldier->ubSoldierUpdateType)
	INJ_SKIP(D, 3)
	...
	INJ_BOOL(D, Soldier->fReactingFromBeingShot)
	...
	INJ_U8(D, Soldier->ubHoursOnAssignment)
	INJ_U8(D, Soldier->ubMercJustFired)
	...
	INJ_U8(D, Soldier->ubPendingActionInterrupted)
	...
	INJ_U8(D, Soldier->ubCTGTTargetID)
	...
	INJ_BOOL(D, Soldier->fDieSoundUsed)
	...
	INJ_I8A(D, Soldier->bFillerBytes, lengthof(Soldier->bFillerBytes))
	...
	INJ_I8(D, Soldier->bYetAnotherPaddingSpace)
