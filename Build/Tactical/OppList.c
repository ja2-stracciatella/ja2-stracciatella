...
static void ProcessNoise(const SOLDIERTYPE* noise_maker, INT16 sGridNo, INT8 bLevel, UINT8 ubTerrType, UINT8 ubBaseVolume, UINT8 ubNoiseType);
...
//	UINT8 ubPlayVolume;
	...
	switch (ubNoiseType)
	{
		...
		default:
			...
			ubSource = SOLDIER2ID(noise_maker);
			break;
	}
