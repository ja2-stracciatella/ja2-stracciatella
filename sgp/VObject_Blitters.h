...
void Blt8BPPDataTo16BPPBufferTransZNBTranslucent(UINT16* buf, UINT32 uiDestPitchBYTES, UINT16* zbuf, UINT16 zbuf, HVOBJECT hSrcVObject, INT32 iX, INT32 iY, UINT16 usIndex);
