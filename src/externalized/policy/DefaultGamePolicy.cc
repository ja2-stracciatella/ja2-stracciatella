...
DefaultGamePolicy::DefaultGamePolicy(const JsonValue& json)
{
	...
	// One I.M.P. per gender is the most that can be handed out: the two genders draw
	// from separate merc profile slots, so anything beyond that would overwrite a
