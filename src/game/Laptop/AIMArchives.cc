...
#define AIM_ALUMNI_START_GRID_X		LAPTOP_SCREEN_UL_X + 37 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_START_GRID_Y		LAPTOP_SCREEN_WEB_UL_Y + 68 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_GRID_OFFSET_X	90 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_GRID_OFFSET_Y	72 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_ALUMNI_FRAME_WIDTH	66 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_ALUMNI_FRAME_HEIGHT	64 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_ALUMNI_FACE_WIDTH	56 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_ALUMNI_FACE_HEIGHT	50 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_NAME_OFFSET_X	5 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_NAME_OFFSET_Y	55 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_NAME_WIDTH		AIM_ALUMNI_ALUMNI_FRAME_WIDTH - AIM_ALUMNI_NAME_OFFSET_X * 2

#define AIM_ALUMNI_PAGE1_X		LAPTOP_SCREEN_UL_X + 100 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_PAGE1_Y		LAPTOP_SCREEN_WEB_UL_Y + 357 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_PAGE_GAP		BOTTOM_BUTTON_START_WIDTH + 25 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_TITLE_X		IMAGE_OFFSET_X + 149 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_TITLE_Y		AIM_SYMBOL_Y + AIM_SYMBOL_SIZE_Y // + 2
#define AIM_ALUMNI_TITLE_WIDTH		AIM_SYMBOL_WIDTH

#define AIM_POPUP_WIDTH			309 * g_ui.m_stdScreenScale
#define AIM_POPUP_TEXT_WIDTH		296 * g_ui.m_stdScreenScale
#define AIM_POPUP_SECTION_HEIGHT	9 * g_ui.m_stdScreenScale

#define AIM_POPUP_X			LAPTOP_SCREEN_UL_X + (500 * g_ui.m_stdScreenScale - AIM_POPUP_WIDTH) / 2
#define AIM_POPUP_Y			STD_SCREEN_Y + 120 + LAPTOP_SCREEN_WEB_DELTA_Y

#define AIM_POPUP_SHADOW_GAP		4 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_FACE_PANEL_X		AIM_POPUP_X + 6 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_FACE_PANEL_Y		AIM_POPUP_Y + 6 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_FACE_PANEL_WIDTH	58 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_FACE_PANEL_HEIGHT	52 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_POPUP_NAME_X		AIM_ALUMNI_FACE_PANEL_X + AIM_ALUMNI_FACE_PANEL_WIDTH + 10 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_POPUP_NAME_Y		AIM_ALUMNI_FACE_PANEL_Y + 20 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_POPUP_DESC_X		AIM_POPUP_X + 8 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_POPUP_DESC_Y		AIM_ALUMNI_FACE_PANEL_Y + AIM_ALUMNI_FACE_PANEL_HEIGHT + 5 * g_ui.m_stdScreenScale

#define AIM_ALUMNI_DONE_X		AIM_POPUP_X + AIM_POPUP_WIDTH - AIM_ALUMNI_DONE_WIDTH - 7 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_DONE_WIDTH		36 * g_ui.m_stdScreenScale
#define AIM_ALUMNI_DONE_HEIGHT		16 * g_ui.m_stdScreenScale
...
void RenderAimArchives()
{
	...
	// Draw Link Title
	DrawTextToScreen(AimAlumniText[AIM_ALUMNI_ALUMNI], AIM_ALUMNI_TITLE_X, AIM_ALUMNI_TITLE_Y, AIM_ALUMNI_TITLE_WIDTH, AIM_ALUMNI_TITLE_FONT, AIM_ALUMNI_TITLE_COLOR, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	...
	for (INT32 i = 0; i != n_faces; ++i, ++face_idx)
	{
		...
		BltVideoObject(FRAME_BUFFER, guiOldAim,      face_idx, x + 4 * g_ui.m_stdScreenScale, y + 4 * g_ui.m_stdScreenScale); // Blt face to screen
		...
		DrawTextToScreen(sText, x + AIM_ALUMNI_NAME_OFFSET_X, y + AIM_ALUMNI_NAME_OFFSET_Y, AIM_ALUMNI_NAME_WIDTH, AIM_ALUMNI_NAME_FONT, AIM_ALUMNI_NAME_COLOR, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	}
...
static void DisplayAlumniOldMercPopUp(void)
{
	...
	DrawTextToScreen(AimAlumniText[AIM_ALUMNI_DONE], AIM_ALUMNI_DONE_X + 1, usPosY - AIM_ALUMNI_DONE_HEIGHT + 3, AIM_ALUMNI_DONE_WIDTH, AIM_ALUMNI_POPUP_NAME_FONT, AIM_ALUMNI_POPUP_NAME_COLOR, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	...
	DrawTextToScreen(sName, AIM_ALUMNI_POPUP_NAME_X, AIM_ALUMNI_POPUP_NAME_Y, 0, AIM_ALUMNI_POPUP_NAME_FONT, AIM_ALUMNI_POPUP_NAME_COLOR, FONT_MCOLOR_TRANSPARENT, LEFT_JUSTIFIED);

	//Display the description
	DisplayWrappedString(AIM_ALUMNI_POPUP_DESC_X, AIM_ALUMNI_POPUP_DESC_Y, AIM_POPUP_TEXT_WIDTH, 2, AIM_ALUMNI_POPUP_FONT, AIM_ALUMNI_POPUP_COLOR, sDesc, FONT_MCOLOR_TRANSPARENT, LEFT_JUSTIFIED);
