...
static void PrintQuizQuestionNumber(void)
{
	...
	mprintf(LAPTOP_SCREEN_UL_X + 345 * g_ui.m_stdScreenScale, LAPTOP_SCREEN_WEB_UL_Y + 370 * g_ui.m_stdScreenScale, L"%d", giCurrentPersonalityQuizQuestion + 1);

	// total number of questions
	MPrint(LAPTOP_SCREEN_UL_X + 383 * g_ui.m_stdScreenScale, LAPTOP_SCREEN_WEB_UL_Y + 370 * g_ui.m_stdScreenScale, L"16");
}
