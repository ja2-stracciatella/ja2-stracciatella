...
#define AIM_FI_PORTRAIT_WIDTH		52 * g_ui.m_stdScreenScale
#define AIM_FI_PORTRAIT_HEIGHT		48 * g_ui.m_stdScreenScale

#define AIM_FI_FIRST_MUGSHOT_X		IMAGE_OFFSET_X + 6 * g_ui.m_stdScreenScale
#define AIM_FI_FIRST_MUGSHOT_Y		IMAGE_OFFSET_Y + 69 * g_ui.m_stdScreenScale//67//70 //68 //65
#define AIM_FI_MUGSHOT_GAP_X		10 * g_ui.m_stdScreenScale
#define AIM_FI_MUGSHOT_GAP_Y		13 * g_ui.m_stdScreenScale
#define AIM_FI_FACE_OFFSET		2 * g_ui.m_stdScreenScale

#define AIM_FI_NNAME_OFFSET_X		2 * g_ui.m_stdScreenScale
#define AIM_FI_NNAME_OFFSET_Y		AIM_FI_PORTRAIT_HEIGHT + 1 * g_ui.m_stdScreenScale
#define AIM_FI_NNAME_WIDTH		AIM_FI_PORTRAIT_WIDTH + 4 * g_ui.m_stdScreenScale

#define AIM_FI_MEMBER_TEXT_X		IMAGE_OFFSET_X + 155 * g_ui.m_stdScreenScale
#define AIM_FI_MEMBER_TEXT_Y		AIM_SYMBOL_Y + AIM_SYMBOL_SIZE_Y + 1 * g_ui.m_stdScreenScale
#define AIM_FI_MEMBER_TEXT_WIDTH	190 * g_ui.m_stdScreenScale

#define AIM_FI_AWAY_TEXT_OFFSET_X	3 * g_ui.m_stdScreenScale
#define AIM_FI_AWAY_TEXT_OFFSET_Y	23 * g_ui.m_stdScreenScale//3//36
#define AIM_FI_AWAY_TEXT_OFFSET_WIDTH	48 * g_ui.m_stdScreenScale
...
void ExitAimFacialIndex()
{
	...
	delete guiMugShotBorder;

	FOR_EACH(SGPVObject*,  i, guiAimFiFace)          delete *i;
...
void RenderAimFacialIndex()
{
	...
	DrawTextToScreen(sString, AIM_FI_MEMBER_TEXT_X, AIM_FI_MEMBER_TEXT_Y,
			 AIM_FI_MEMBER_TEXT_WIDTH, AIM_MAINTITLE_FONT, AIM_MAINTITLE_COLOR, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	...
	for(y=0; y<AIM_FI_NUM_MUHSHOTS_Y; y++)
	{
		for(x=0; x<AIM_FI_NUM_MUHSHOTS_X; x++)
		{
			...
			DrawTextToScreen(gMercProfiles[AimMercArray[i]].zNickname, usPosX - AIM_FI_NNAME_OFFSET_X, usPosY + AIM_FI_NNAME_OFFSET_Y,
					AIM_FI_NNAME_WIDTH, AIM_FONT12ARIAL, AIM_FONT_MCOLOR_WHITE, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	...
	DrawTextToScreen(AimFiText[AIM_FI_LEFT_CLICK], AIM_FI_LEFT_CLICK_TEXT_X, AIM_FI_LEFT_CLICK_TEXT_Y,
			 AIM_FI_CLICK_TEXT_WIDTH, AIM_FI_HELP_TITLE_FONT, AIM_FONT_MCOLOR_WHITE, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	DrawTextToScreen(AimFiText[AIM_FI_TO_SELECT],  AIM_FI_LEFT_CLICK_TEXT_X, AIM_FI_LEFT_CLICK_TEXT_Y + AIM_FI_CLICK_DESC_TEXT_Y_OFFSET,
			 AIM_FI_CLICK_TEXT_WIDTH, AIM_FI_HELP_FONT,       AIM_FONT_MCOLOR_WHITE, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);

	DrawTextToScreen(AimFiText[AIM_FI_RIGHT_CLICK],        AIM_FI_RIGHT_CLICK_TEXT_X, AIM_FI_LEFT_CLICK_TEXT_Y,
			 AIM_FI_CLICK_TEXT_WIDTH, AIM_FI_HELP_TITLE_FONT, AIM_FONT_MCOLOR_WHITE, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	DrawTextToScreen(AimFiText[AIM_FI_TO_ENTER_SORT_PAGE], AIM_FI_RIGHT_CLICK_TEXT_X, AIM_FI_LEFT_CLICK_TEXT_Y + AIM_FI_CLICK_DESC_TEXT_Y_OFFSET,
			 AIM_FI_CLICK_TEXT_WIDTH, AIM_FI_HELP_FONT,       AIM_FONT_MCOLOR_WHITE, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
...
static void DrawMercsFaceToScreen(const UINT8 ubMercID, const UINT16 usPosX, const UINT16 usPosY, const UINT8 ubImage)
{
	...
	if (shaded)
	{
		FRAME_BUFFER->ShadowRect(usPosX + AIM_FI_FACE_OFFSET, usPosY + AIM_FI_FACE_OFFSET,
					 usPosX + 48 * g_ui.m_stdScreenScale + AIM_FI_FACE_OFFSET, usPosY + 43 * g_ui.m_stdScreenScale + AIM_FI_FACE_OFFSET);
	}

	if (!text.empty())
	{
		DrawTextToScreen(text, usPosX + AIM_FI_AWAY_TEXT_OFFSET_X, usPosY + AIM_FI_AWAY_TEXT_OFFSET_Y,
				 AIM_FI_AWAY_TEXT_OFFSET_WIDTH, FONT10ARIAL, FONT_COLOR_P145, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	}
}
