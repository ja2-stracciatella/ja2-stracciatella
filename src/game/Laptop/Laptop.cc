...
static void CreateLaptopButtons(void)
{
	...
	MakeButton(1,  98 * g_ui.m_stdScreenScale, WWWRegionButtonCallback,
...
void RenderWWWProgramTitleBar(void)
{
	...
	else
	{
		...
		mprintf(STD_SCREEN_X + 140 * g_ui.m_stdScreenScale, STD_SCREEN_Y + 33 * g_ui.m_stdScreenScale,
			L"%ls  -  %ls", pWebTitle, pWebPagesTitles[iIndex]);
	}
