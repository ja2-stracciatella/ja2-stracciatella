...
static void DrawEmailSummary(INT32 y, const Email* e)
{
	...
	ReduceStringLength(pTempSubject, lengthof(pTempSubject), SUBJECT_WIDTH - 10 * g_ui.m_stdScreenScale, font);
	...
	mprintf(DATE_X, y + 4 * g_ui.m_stdScreenScale, L"%ls %d", pDayStrings, e->iDate / (24 * 60));
}
...
static void DisplayEmailMessageSubjectDateFromLines(Email* pMail, INT32 iViewerY)
{
	...
	mprintf(MESSAGE_HEADER_X + 235 * g_ui.m_stdScreenScale, MESSAGE_DATE_Y + iViewerY, L"%d", pMail->iDate / (24 * 60));
