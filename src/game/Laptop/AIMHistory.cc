...
#define AIM_HISTORY_MENU_Y			(STD_SCREEN_Y + 370 * g_ui.m_stdScreenScale + LAPTOP_SCREEN_WEB_DELTA_Y)
#define AIM_HISTORY_MENU_BUTTON_AMOUNT		4
#define AIM_HISTORY_GAP_X			(40 * g_ui.m_stdScreenScale + BOTTOM_BUTTON_START_WIDTH)

#define AIM_HISTORY_TEXT_X			(IMAGE_OFFSET_X + 149 * g_ui.m_stdScreenScale)
#define AIM_HISTORY_TEXT_Y			AIM_SYMBOL_Y + AIM_SYMBOL_SIZE_Y + 45 * g_ui.m_stdScreenScale
#define AIM_HISTORY_TEXT_WIDTH			AIM_SYMBOL_WIDTH

#define AIM_HISTORY_PARAGRAPH_X			LAPTOP_SCREEN_UL_X + 20 * g_ui.m_stdScreenScale
#define AIM_HISTORY_PARAGRAPH_Y			AIM_HISTORY_SUBTITLE_Y + 18 * g_ui.m_stdScreenScale
#define AIM_HISTORY_SUBTITLE_Y			(150 * g_ui.m_stdScreenScale + LAPTOP_SCREEN_WEB_DELTA_Y + STD_SCREEN_Y)
#define AIM_HISTORY_PARAGRAPH_WIDTH		460 * g_ui.m_stdScreenScale

#define AIM_HISTORY_CONTENTBUTTON_X		(259 * g_ui.m_stdScreenScale + STD_SCREEN_X)
#define AIM_HISTORY_CONTENTBUTTON_Y		AIM_HISTORY_SUBTITLE_Y

#define AIM_HISTORY_TOC_X			AIM_HISTORY_CONTENTBUTTON_X
#define AIM_HISTORY_TOC_Y			5 * g_ui.m_stdScreenScale
#define AIM_HISTORY_TOC_GAP_Y			25 * g_ui.m_stdScreenScale

#define AIM_HISTORY_SPACE_BETWEEN_PARAGRAPHS	8 * g_ui.m_stdScreenScale
...
void RenderAimHistory()
{
	...
	DrawTextToScreen(AimHistoryText[AIM_HISTORY_TITLE], AIM_HISTORY_TEXT_X, AIM_HISTORY_TEXT_Y,
			 AIM_HISTORY_TEXT_WIDTH, AIM_HISTORY_TITLE_FONT, AIM_HISTORY_TITLE_COLOR, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
	...
	switch(gubCurPageNum)
	{
		...
		case 4:
			...
			DisplayWrappedString(AIM_HISTORY_PARAGRAPH_X, 210 * g_ui.m_stdScreenScale + LAPTOP_SCREEN_WEB_DELTA_Y + STD_SCREEN_Y,
						AIM_HISTORY_PARAGRAPH_WIDTH, 2 * g_ui.m_stdScreenScale,
						AIM_HISTORY_TEXT_FONT, AIM_HISTORY_TEXT_COLOR, sText, FONT_MCOLOR_TRANSPARENT, RIGHT_JUSTIFIED);
			break;
		...
		case 5:
			...
			DisplayWrappedString(AIM_HISTORY_PARAGRAPH_X, 270 * g_ui.m_stdScreenScale + LAPTOP_SCREEN_WEB_DELTA_Y + STD_SCREEN_Y,
						AIM_HISTORY_PARAGRAPH_WIDTH, 2 * g_ui.m_stdScreenScale,
						AIM_HISTORY_TEXT_FONT, AIM_HISTORY_TEXT_COLOR, sText, FONT_MCOLOR_TRANSPARENT, RIGHT_JUSTIFIED);

			//AIM_HISTORY_PARAGRAPH_Y
			sText = LoadAIMHistoryText(INCORPORATION_3);
			DisplayWrappedString(AIM_HISTORY_PARAGRAPH_X, 290 * g_ui.m_stdScreenScale + LAPTOP_SCREEN_WEB_DELTA_Y + STD_SCREEN_Y,
						AIM_HISTORY_PARAGRAPH_WIDTH, 2 * g_ui.m_stdScreenScale,
						AIM_HISTORY_TEXT_FONT, AIM_HISTORY_TEXT_COLOR, sText, FONT_MCOLOR_TRANSPARENT, LEFT_JUSTIFIED);
			break;
	}
...
static void DisplayAimHistoryParagraph(UINT8 ubPageNum, UINT8 ubNumParagraphs)
{
	...
	DrawTextToScreen(sText, AIM_HISTORY_PARAGRAPH_X, AIM_HISTORY_SUBTITLE_Y,
			0, AIM_HISTORY_PARAGRAPH_TITLE_FONT, AIM_HISTORY_PARAGRAPH_TITLE_COLOR, FONT_MCOLOR_TRANSPARENT, LEFT_JUSTIFIED);
	...
	if(ubNumParagraphs >= 1)
	{
		...
		usNumPixels = DisplayWrappedString(AIM_HISTORY_PARAGRAPH_X, usPosY,
							AIM_HISTORY_PARAGRAPH_WIDTH, 2 * g_ui.m_stdScreenScale,
							AIM_HISTORY_TEXT_FONT, AIM_HISTORY_TEXT_COLOR, sText, FONT_MCOLOR_TRANSPARENT, LEFT_JUSTIFIED);
	}
	...
	if(ubNumParagraphs >= 2)
	{
		...
		DisplayWrappedString(AIM_HISTORY_PARAGRAPH_X, usPosY,
					AIM_HISTORY_PARAGRAPH_WIDTH, 2 * g_ui.m_stdScreenScale,
					AIM_HISTORY_TEXT_FONT, AIM_HISTORY_TEXT_COLOR, sText, FONT_MCOLOR_TRANSPARENT, LEFT_JUSTIFIED);
	}
	...
	for(i=0; i<NUM_AIM_HISTORY_PAGES; i++)
	{
		...
		if( !gfInToc )
		{
			...
			MSYS_DefineRegion( &gSelectedHistoryTocMenuRegion[i], AIM_HISTORY_TOC_X, usPosY,
					   (UINT16)(AIM_HISTORY_TOC_X + AIM_CONTENTBUTTON_WIDTH), (UINT16)(usPosY + AIM_CONTENTBUTTON_HEIGHT), MSYS_PRIORITY_HIGH,
		...
		DrawTextToScreen(sText, AIM_HISTORY_TOC_X, usPosY + AIM_HISTORY_TOC_Y,
				 AIM_CONTENTBUTTON_WIDTH, AIM_HISTORY_TOC_TEXT_FONT, AIM_HISTORY_TOC_TEXT_COLOR, FONT_MCOLOR_TRANSPARENT, CENTER_JUSTIFIED);
