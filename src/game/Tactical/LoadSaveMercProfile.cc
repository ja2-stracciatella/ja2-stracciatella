...
bool IMPSavedProfileHasVersion(BYTE const* const Src, size_t const size)
{
	return size >= sizeof(IMP_PROFILE_MAGIC) + sizeof(UINT32) &&
...
{
	if (!IMPSavedProfileHasVersion(Src, size))
	{
