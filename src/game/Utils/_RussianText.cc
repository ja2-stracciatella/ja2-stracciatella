...
static const ST::string s_rus_zSaveLoadText[zSaveLoadText_SIZE] =
{
	...
	"Версия сохраненной игры отличается от текущей. Скорее всего, игра загрузится нормально.",
	"Вы уверены, что хотите удалить сохраненную игру с именем \"%s\"?",

	"Внимание:",
	"Попытка загрузить сохранение из более старой версии. Продолжение автоматически обновит сохранение.",
	"У вас включены моды, отличные от тех, с которыми была сохранена игра. Моды могут работать некорректно.",
	"Загрузить?",

	"Вы уверены, что хотите перезаписать сохраненную игру под названием \"%s\"?",
