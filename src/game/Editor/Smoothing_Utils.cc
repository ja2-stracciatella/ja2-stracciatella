...
#include "game/TileEngine/WorldDef.h"	//for LEVELNODE def
#include "game/TileEngine/WorldMan.h" //for RemoveXXXX()
#include "game/TileEngine/Isometric_Utils.h" //for GridNoOnVisibleWorldTile()
