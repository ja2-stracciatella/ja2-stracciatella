...
if("${CMAKE_GENERATOR_PLATFORM}" STREQUAL "" AND "${CMAKE_GENERATOR}" MATCHES "^Visual Studio ")
...
elseif("${CMAKE_GENERATOR_PLATFORM}" MATCHES "(Win64|x64)")
...
elseif("${CMAKE_GENERATOR_PLATFORM}" STREQUAL "")
	...
	message(FATAL_ERROR "target platform is not supported: '${CMAKE_GENERATOR_PLATFORM}'")
endif()
